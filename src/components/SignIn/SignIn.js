...
const SignIn = ({ buttonSignIn, buttonRegister }) => {
  return (
    <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
      <div className="pa4 black-80">
        <div className="measure">
          ...
          <div className="">
            <input className="b br2 ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib sign-in-btn" type="submit" value="Sign in" onClick={() => buttonSignIn('home')}/>
          </div>
